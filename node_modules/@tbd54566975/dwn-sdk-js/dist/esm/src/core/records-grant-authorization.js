...
export class RecordsGrantAuthorization {
    ...
    static authorizeWrite(tenant, incomingMessage, author, messageStore) {
        return __awaiter(this, void 0, void 0, function* () {
            const permissionsGrantMessage = yield GrantAuthorization.authorizeGenericMessage(tenant, incomingMessage, author, incomingMessage.signaturePayload.permissionsGrantId, messageStore);
